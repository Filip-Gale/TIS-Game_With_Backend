...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
  @Query(nativeQuery = true, value = "SELECT FIRST_NAME, LAST_NAME, SALARY, STARTING_WORK_DATE, VACATION_DAYS, POSITION_ID FROM EMPLOYEE")
  List<Employee> fetchAllEmployees();

  @Query(nativeQuery = true, value = "SELECT FIRST_NAME, LAST_NAME, SALARY, STARTING_WORK_DATE, VACATION_DAYS, POSITION_ID FROM EMPLOYEE e WHERE e.ID = :id")
  ...
  @Query(nativeQuery = true, value = "SELECT FIRST_NAME, LAST_NAME, SALARY, STARTING_WORK_DATE, VACATION_DAYS, POSITION_ID FROM EMPLOYEE e WHERE (:first_name is null OR e.FIRST_NAME = :first_name) AND (:starting_work_date is null OR e.STARTING_WORK_DATE = :starting_work_date)")
